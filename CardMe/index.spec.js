...
describe("The miner", () => {
    ...
    function arrange(reminders) {
        ...
        _mocked.slack.reminders.get.mockReturnValueOnce(Promise.resolve({ reminders: reminders["toke"] }));
        _mocked.slack.reminders.get.mockReturnValueOnce(Promise.resolve({ reminders: reminders["en"] }));
